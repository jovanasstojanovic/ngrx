...
import { Directive, Input, HostBinding, HostListener, InjectionToken, Injectable, Inject, EventEmitter, Output, NgModule } from '@angular/core';
...
class ToggleAudioUserDirective {
    ...
    toggleUserAudio() {
        ...
        if ((_a = this.ngxWebrtcToggleAudioUser) === null || _a === void 0 ? void 0 : _a.connection) {
...
class ToggleVideoUserDirective {
    ...
    toggleUserVideo() {
        ...
        if ((_a = this.ngxWebrtcToggleVideoUser) === null || _a === void 0 ? void 0 : _a.connection) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.1", ngImport: i0, type: PreferencesService, decorators: [{
        ...
        return [{ type: Configuration }, { type: undefined, decorators: [{
                        type: Inject,
...
class StreamService {
    ...
    stopStreamInNode(node) {
        var _a, _b, _c, _d;
        (_a = node === null || node === void 0 ? void 0 : node.nativeElement) === null || _a === void 0 ? void 0 : _a.pause();
        (_c = (_b = node === null || node === void 0 ? void 0 : node.nativeElement) === null || _b === void 0 ? void 0 : _b.srcObject) === null || _c === void 0 ? void 0 : _c.getTracks().forEach((t) => t.stop());
        if ((_d = node === null || node === void 0 ? void 0 : node.nativeElement) === null || _d === void 0 ? void 0 : _d.srcObject) {
    ...
    replaceTrackInStream(stream, track) {
        if (track.kind === StreamType.Video) {
            stream === null || stream === void 0 ? void 0 : stream.getVideoTracks().forEach(e => {
                e.stop();
                stream.removeTrack(e);
            });
        }
        if (track.kind === StreamType.Audio) {
            stream === null || stream === void 0 ? void 0 : stream.getAudioTracks().forEach((e) => {
                e.stop();
                stream.removeTrack(e);
            });
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (n.getDisplayMedia) {
                    stream = yield n.getDisplayMedia({ video: true });
                }
                else if (n.mediaDevices.getDisplayMedia) {
                    stream = yield n.mediaDevices.getDisplayMedia({ video: true });
                }
                else {
                    stream = yield n.mediaDevices.getUserMedia({ video: { mediaSource: 'screen' } });
                }
            }
            catch (e) {
                if (this.config.debug) {
    ...
    getVideoTrackForStream(stream) {
        ...
        return (stream === null || stream === void 0 ? void 0 : stream.getVideoTracks()[0]) || null;
    }
    /**
    ...
    getAudioTrackForStream(stream) {
        ...
        return (stream === null || stream === void 0 ? void 0 : stream.getAudioTracks()[0]) || null;
    }
    /**
        ...
        return new Promise((resolve, reject) => {
            navigator.mediaDevices.getUserMedia(mediaConstraints).then(a => {
                ...
                navigator.mediaDevices.enumerateDevices().then((devices) => {
                    ...
                    const constraints = {
                        video: cam && (mediaConstraints === null || mediaConstraints === void 0 ? void 0 : mediaConstraints.video),
                        audio: mic && (mediaConstraints === null || mediaConstraints === void 0 ? void 0 : mediaConstraints.audio)
                    };
...
class SdpUtils {
    ...
    static maybeRemoveVideoFec(sdp, params) {
        ...
        const rtxPayloadType = fmtpLine === null || fmtpLine === void 0 ? void 0 : fmtpLine.pt;
    ...
    static writeFmtpLine(fmtpObj) {
        ...
        return 'a=fmtp:' + (pt === null || pt === void 0 ? void 0 : pt.toString()) + ' ' + keyValues.join(';');
    }
...
class PeerConnectionClient {
    ...
    createOffer(offerOptions = {}) {
        ...
        const constraints = Object.assign(Object.assign({}, this.DEFAULT_SDP_OFFER_OPTIONS), offerOptions);
    ...
    addTrack(track) {
        ...
        if (this.connection) {
            const sender = this.connection.getSenders().find((s) => {
                var _a;
                return ((_a = s === null || s === void 0 ? void 0 : s.track) === null || _a === void 0 ? void 0 : _a.kind) === track.kind;
            });
    ...
    receiveSignalingMessage(message) {
        ...
        if (((_a = this.connection) === null || _a === void 0 ? void 0 : _a.iceGatheringState) === 'complete' ||
    ...
    onRecordIceCandidate(location, candidateObj) {
        if (candidateObj === null || candidateObj === void 0 ? void 0 : candidateObj.candidate) {
...
class ToggleVideoSelfDirective {
    ...
    ngOnDestroy() {
        var _a, _b;
        (_a = this.callStartedSubscription$) === null || _a === void 0 ? void 0 : _a.unsubscribe();
        (_b = this.localStreamStatusChangedSubscription$) === null || _b === void 0 ? void 0 : _b.unsubscribe();
    }
    init() {
...
class ShareScreenDirective {
    ...
    startShareScreen() {
        return __awaiter(this, void 0, void 0, function* () {
            this.desktopStream = yield this.streamService.getScreenCapture();
    ...
    changeSelectedDevice(deviceId, kind) {
        return new Promise((resolve, rejects) => {
            ...
            if (kind === DeviceType.VideoInput) {
                if (((_a = this.selectedVideoInput$.getValue()) === null || _a === void 0 ? void 0 : _a.deviceId) === deviceId) {
                    resolve();
                }
            ...
            if (kind === DeviceType.AudioInput) {
                if (((_b = this.selectedAudioInput$.getValue()) === null || _b === void 0 ? void 0 : _b.deviceId) === deviceId) {
                    resolve();
                }
